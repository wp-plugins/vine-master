...
//MULTISITE TABLE
if (is_multisite()){
if(!class_exists('vine_master_admin_updater_multisite')){
	require_once( dirname( __FILE__ ) . '/vine-master-admin-updater-multisite-table.php');
}
//Prepare Table of elements
$wp_list_table = new vine_master_admin_updater_multisite_table();
//Table of elements
...
if( is_multisite() ) {
add_action( 'network_admin_menu', 'menu_single_vine_admin_updater' );
