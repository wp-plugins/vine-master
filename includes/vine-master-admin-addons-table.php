...
class vine_master_admin_addons_table extends WP_List_Table {
	...
	if ( is_plugin_active( 'vine-master-addons/vine-master-addons.php' ) && file_exists($path) ) {
		...
		$vine_master_addon_get = '<a class="button-primary" href="http://wordpress.techgasp.com/vine-master/" target="_blank" title="Get Add-ons" style="float:left;">Get Add-ons</a>';
	}
?>
<table class="widefat fixed" cellspacing="0">
	<thead>
		<tr>
			...
			<th id="columnname" class="manage-column column-columnname" scope="col"><h3><img src="<?php echo plugins_url('images/techgasp-minilogo-16.png', dirname(__FILE__)); ?>" style="float:left; height:16px; vertical-align:middle;" /><?php _e('&nbsp;Installed', 'vine_master'); ?></h3></legend></th>
		</tr>
	</thead>

	<tfoot>
		<tr>
			<th class="manage-column column-columnname" scope="col" width="300"><?php echo $vine_master_addon_get; ?></th>
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-vinemaster-admin-addons-widget-viral.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('vine_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
			...
			<td class="column-columnname" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-check-yes.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('vine_master_name'); ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-vinemaster-admin-addons-widget-player.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('vine_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
			...
			<td class="column-columnname" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-check-'.$vine_master_addon.'.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('vine_master_name'); ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-vinemaster-admin-addons-widget-feed.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('vine_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-vinemaster-admin-addons-shortcode-in.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('vine_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-vinemaster-admin-addons-shortcode-un.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('vine_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-vinemaster-admin-addons-updater.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('vine_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-vinemaster-admin-addons-support.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('vine_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
